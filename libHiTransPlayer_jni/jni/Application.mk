...
# the compiler will identity warmming to err, use ndk-r9d
# -Wno-error=format-security,the compiler will nolonger identify warmming to err
APP_CFLAGS += -Wno-error=format-security
APP_CFLAGS := $(APP_CFLAGS) $(OPT_CFLAGS) -fPIC
APP_CPPFLAGS := $(APP_CPPFLAGS) $(OPT_CPPFLAGS)
APP_CPPFLAGS += -fexceptions -fno-rtti -fPIC -Wno-error=format-security
